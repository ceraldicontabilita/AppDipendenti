...
def register_all_handlers():
    ...
    try:
        from backend.app.services.handlers.fattura_handlers import (
    ...
    try:
        from backend.app.services.handlers.banca_handlers import (
    ...
    # --- Fase 4: F24 (Chat 9c) ---
    try:
        from backend.app.services.handlers.f24_handlers import (
    ...
    try:
        from backend.app.services.handlers.cedolino_handlers import (
    ...
    try:
        from backend.app.services.handlers.corrispettivo_handlers import on_corrispettivo_split
    ...
    try:
        from backend.app.services.handlers.trasferimento_handlers import on_trasferimento_crea_lato_opposto
    ...
    # --- Dipendenti (Chat 9d) ---
    try:
        from backend.app.services.handlers.dipendente_handlers import (
    ...
    # --- Magazzino (Chat 9d) ---
    try:
        from backend.app.services.handlers.magazzino_handlers import on_fattura_righe_magazzino
    ...
    try:
        from backend.app.services.handlers.documento_handlers import (
